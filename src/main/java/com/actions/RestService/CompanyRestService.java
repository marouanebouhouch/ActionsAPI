...
public class CompanyRestService {
    ...
    @RequestMapping(value = "/companies/{company_id}/tags/{tag_id}", method = RequestMethod.PUT)
    public ResponseEntity<Company> deleteTagFromCompany(@PathVariable("company_id") Long company_id, @PathVariable("tag_id") Long tag_id){
